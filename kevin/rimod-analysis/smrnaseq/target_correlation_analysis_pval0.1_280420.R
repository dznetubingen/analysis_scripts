...
library(biomaRt)
library(stringr)
setwd("/Users/kevin/dzne/rimod_package/smRNAseq/analysis/")
...
# mrna expression
mrna <- read.table("/Users/kevin/dzne/rimod_package/analysis/RNAseq_analysis_fro_2019-10-23_13.33.11/deseq_vst_values_2019-10-23_13.33.11.txt", sep="\t", header=T, row.names=1)
...
###############
setwd("/Users/kevin/dzne/rimod_package/smRNAseq/analysis/target_mrna_correlation_pval0.1_0420/")
# Cutoffs
