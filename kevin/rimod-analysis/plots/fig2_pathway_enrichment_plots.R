...
# load data
mapt.up <- read.csv("~/rimod/RNAseq/analysis/pathways_analysis/gprofiler/mapt_ccf_degs_up.csv")
mapt.down <- read.csv("~/rimod/RNAseq/analysis/pathways_analysis/gprofiler/mapt_ccf_degs_down.csv")
grn.up <- read.csv("~/rimod/RNAseq/analysis/pathways_analysis/gprofiler/grn_ccf_degs_up.csv")
grn.down <- read.csv("~/rimod/RNAseq/analysis/pathways_analysis/gprofiler/grn_ccf_degs_down.csv")
c9 <- read.csv("~/rimod/RNAseq/analysis/pathways_analysis/gprofiler/c9orf72_all_degs.csv")
...
p1 <- make_enrichment_plot(grn.up, source="REAC", cut=no_terms, title="FTD-GRN Up")
ggsave("grn_up_enrichment.png", width=6, height = 3)
p2 <- make_enrichment_plot(grn.down, source="REAC", cut=no_terms, title="FTD-GRN Down")
