...
rna.mapt <- read.table("~/rimod/RNAseq/analysis/RNAseq_analysis_fro_2020-05-04_15.45.57/deseq_result_mapt.ndc_fro_2020-05-04_15.45.57.txt", sep="\t", header=T, row.names=1)
rna.grn <- read.table("~/rimod/RNAseq/analysis/RNAseq_analysis_fro_2020-05-04_15.45.57/deseq_result_grn.ndc_fro_2020-05-04_15.45.57.txt", sep="\t", header=T, row.names=1)
rna.c9 <- read.table("~/rimod/RNAseq/analysis/RNAseq_analysis_fro_2020-05-04_15.45.57/deseq_result_c9.ndc_fro_2020-05-04_15.45.57.txt", sep="\t", header=T, row.names=1)
...
srna.mapt <- read.table("~/rimod/smallRNA/frontal/analysis/analysis_0719/deseq_result_mapt.ndc_frontal_smRNAseq.txt", sep="\t", header=T, row.names=1)
srna.grn <- read.table("~/rimod/smallRNA/frontal/analysis/analysis_0719/deseq_result_grn.ndc_frontal_smRNAseq.txt", sep="\t", header=T, row.names=1)
srna.c9 <- read.table("~/rimod/smallRNA/frontal/analysis/analysis_0719/deseq_result_c9.ndc_frontal_smRNAseq.txt", sep="\t", header=T, row.names=1)
...
srna.mapt <- srna.mapt[abs(srna.mapt$log2FoldChange) >= lfc_cut,]
srna.grn <- srna.grn[abs(srna.grn$log2FoldChange) >= lfc_cut,]
srna.c9 <- srna.c9[abs(srna.c9$log2FoldChange) >= lfc_cut,]
