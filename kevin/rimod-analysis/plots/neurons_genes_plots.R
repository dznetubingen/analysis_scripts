...
setwd("/Users/kevin/OneDrive/work_dzne/rimod/rimod_neurons/rimod_neurons/")
...
# genes to plot
genes <- c("GRN", "OPTN", "CHCHD10", "ANGPT1", "C9orf72", "MAPT", "WNT9A", "SOX2", "ADGRB1")
...
ggsave("/Users/kevin/OneDrive/work_dzne/rimod/paper/figures/figure6/boxplot_neurons.png", width=3.5, height=11)
