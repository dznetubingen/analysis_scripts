...
pheatmap(pval.df, color = viridis(200), filename = "WGCNA_pvalue_heatmap.png")
...
pval.df[pval.df > 0.05] <- 1
pheatmap(pval.df, color = viridis(200), filename = "WGCNA_pvalue_heatmap_all.png")
pheatmap(moduleTraitCor, viridis(200), filename = "WGCNA_cor_heatmap_all.png")
