...
#
# Comparison examined:    FTD.MAPT - NDC
#
...
# Setw working directory
setwd("~/rimod/smallRNA/analysis/network_analysis_FTD.MAPT//")
...
## Load DEG files
mirna.deg <- read.table("~/rimod/smallRNA/analysis/deseq_analysis_FTD.MAPT-NDC_070218/DEGs_sRNA_DESeq_FTD.MAPT.NDC_070218.txt", sep="\t", header=T, row.names = 1)
rna.deg <- read.table("~/rimod/RNAseq/analysis/deseq_analysis_FTD.MAPT.NDC_070218/DEGs_RNAseq_frontal_RiMod_pva005_FTD.MAPT.NDC.txt", sep="\t", header=T, row.names=1)
...
write_graph(g, "~/rimod/smallRNA/analysis/network_analysis_FTD.MAPT/smallRNA_gene_network_lfc0.5_cor0.5_MAPT-NDC.gml", format = "gml")
...
# save graph 
write_graph(g2, file = "smallRNA_gene_network_lfc0.5_cor0.5_communities_degreefiltered_MAPT-NDC.gml")
