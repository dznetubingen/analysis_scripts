...
#
# Comparison examined:    FTD.C9orf72 - NDC
#
...
setwd("~/rimod/smallRNA/analysis/network_analysis_FTD.C9/")
...
rna.deg <- read.table("~/rimod/RNAseq/analysis/deseq_analysis_FTD.C9.NDC_070218/DEGs_RNAseq_frontal_RiMod_pva005_FTD.C9orf72.NDC.txt", sep="\t", header=T, row.names=1)
...
write_graph(g, "~/rimod/smallRNA/analysis/network_analysis_FTD.C9/smallRNA_gene_network_lfc0.5_cor0.5.gml", format = "gml")
...
# save graph 
write_graph(g2, file = "smallRNA_gene_network_lfc0.5_cor0.5_communities_degreefiltered.gml")
